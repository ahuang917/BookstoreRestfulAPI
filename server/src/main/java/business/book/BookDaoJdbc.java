...
public class BookDaoJdbc implements BookDao {
    ...
    public List<Book> findByCategoryId(long categoryId) {
        ...
        try (Connection connection = JdbcUtils.getConnection();
            ...
            throw new BookstoreQueryDbException("Encountered a problem finding book by categoryID" + categoryId, e);
        }
        return books;
    }
    ...
    public List<Book> findRandomByCategoryId(long categoryId, int limit) {
        ...
        try (Connection connection = JdbcUtils.getConnection();
            ...
            throw new BookstoreQueryDbException("Encountered a problem finding suggested books by categoryID" + categoryId, e);
        }
        return books;
    }
